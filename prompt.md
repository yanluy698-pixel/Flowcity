...
- 本地周末出行默认不是通宵场景。用户说“中午一点”“下午一点”或在“周末出去玩/集合/出发/逛/吃”的语境里说“1 点、2 点”，应解析为 `13:00`、`14:00`。
- 只有用户明确说“凌晨”“半夜”“深夜”“通宵”“夜里 1 点/2 点”等，才把 1 点、2 点理解为凌晨时间。
- 用户说“晚上 6 点到 10 点”“今晚 6 点半，10 点前结束”，应解析为 `18:00/18:30` 到 `22:00`，不要输出 `06:00` 或 `10:00`。
